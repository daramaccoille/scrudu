  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl flex flex-col items-center gap-4">
      <div className="flex justify-between items-center mb-2 w-full">
        <h3 className="text-xl font-semibold">{t.question} {question.number}{question.focheist}</h3>
        <button 
      ...
      <div className={clsx(
        'transition-all duration-500 ease-in-out overflow-hidden max-h-0 rounded-lg w-full text-right',
        {
          'max-h-[500px] p-6 mt-4': showFeedback,
          'bg-green-100 border-green-200': isSubmitted && isCorrect,
          'bg-red-100 border-red-200': isSubmitted && !isCorrect,
          'bg-gray-50 border-gray-200': !isSubmitted
        }
      )}>
